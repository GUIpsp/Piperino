...
public class ModelPipe extends ModelBase {
    ...
    public static class PipeRenderer extends ModelRenderer {
        ...
        public static class ModelPipeBoxArms extends ModelBox {
            private int armside;
            private int outside;
            private TexturedQuad[] quadList;
            private PositionTextureVertex[] vertexPositions;

            public ModelPipeBoxArms(ModelRenderer par1ModelRenderer, int par2, int par3, float par4, float par5, float par6, int par7, int par8, int par9, float par10, boolean flip, int armside) {
                super(par1ModelRenderer, par2, par3, par4, par5, par6, par7, par8, par9, par10);
                this.armside = armside;
                this.outside = ForgeDirection.getOrientation(armside).getOpposite().ordinal();
            ...
            public void render(Tessellator par1Tessellator, float par2) {
                for (int i = 0; i < this.quadList.length; ++i) {
                    if (!connections[i]) {
                        ...
                        arms[i].render(par1Tessellator, par2);
                    }
                }
            }
        }
